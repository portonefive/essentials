<?php namespace PortOneFive\Essentials\Pagination;
...
class FoundationPresenter implements Presenter
{
    ...
    public function getPageRange($start, $end)
    {
        ...
        for ($page = $start; $page <= $end; $page++) {
            ...
            if ($this->currentPage() == $page) {
                $pages[] = '<li class="current has-form"><a href="#">' . $page . '</a></li>';
            } else {
    ...
    {
        return '<li class="unavailable has-form"><a>' . $text . '</a></li>';
    }
    ...
    protected function getAvailablePageWrapper($url, $page, $rel = null)
    {
        ...
        return '<li class="has-form"><a href="' . $url . '"' . $rel . '>' . $page . '</a></li>';
    }
    ...
    {
        return '<li class="current has-form"><a>' . $text . '</a></li>';
    }
